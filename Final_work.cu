...
//int compute_feature2(compute_feature(const char* seq, double * features,int i))
//{
//	//	int count = 0;
//		int all_count= 0;
//		char* pointer = (char*)seq+i*MAX_LENGTH;
//		double* current_feaure_array = features + FEATURE_LENGTH*i;
//		char ch;
//		double sw_sum = 0;
//		while(ch = *pointer)
